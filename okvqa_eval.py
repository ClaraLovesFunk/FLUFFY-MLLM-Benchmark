...
class VQAEval:
    ...
    def evaluate(self, gts, res, quesIds):
        ...
        for quesId in quesIds:
            ...
            avgGTAcc = 1 if correct_answer else 0
        ...
        acc = round(100 * float(sum(accQA)) / len(accQA), self.n)
        return acc
