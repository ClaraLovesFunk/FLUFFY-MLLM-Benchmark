...
def evaluate_mami(CONFIG_PATH, dataset_name, model_name, mode, run):
    ...
    for task in tasks:
        ...
        scores = compute_standard_metrics(y_true, y_pred, pos_label = POS_LABEL, average='binary', zero_division=0, flag_only_acc = False)
